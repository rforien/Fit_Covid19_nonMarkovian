...
fit_total.dates_end_fit = ['2020-06-15', '2020-07-21', '2020-10-30', '2020-12-12']
if francais:
    fit_total.names_fit = ['confinement (jusqu\'au 2 juin)', 'après le 2 juin', 'deuxieme vague', 'second confinement']
else:
    fit_total.names_fit = ['1st lockdown (until June 2nd)', 'after June 2nd', 'second wave']
fit_total.delays = np.array([[28], [15], [35], [16]])
