...
data = pd.read_csv('donnees-hospitalieres-covid19-2020-07-07-19h00.csv', delimiter = ';')
...
data.to_csv('donnees-hospitalieres-covid19-2020-07-07-19h00_corrected.csv', sep = ';')