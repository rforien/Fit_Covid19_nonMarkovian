...
data = pd.read_csv('donnees-hospitalieres-covid19-2020-07-01-19h00_corrected.csv', delimiter = ';')
data_new = pd.read_csv('donnees-hospitalieres-nouveaux-covid19-2020-07-01-19h00.csv', delimiter = ';')
...
fit_total.compute_sir(.6, f, '2021-03-01')
