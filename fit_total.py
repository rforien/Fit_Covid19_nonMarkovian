...
fit_total.plot_immunity([.003, .005, .01], .6, False)
#print(fit_total._fit_reported(np.array([.4, 14.7, .2, 5, .5])))
...
#fit_total.compute_sir(.33, f, end_of_run = '2020-06-17', Markov = False)
